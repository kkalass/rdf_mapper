...
// in rdf_mapper/test/src/deserializers/blank_node_term_deserializer_test.dart.
...
class MockDeserializationContext extends _i1.Mock
  ...
  T require<T>(
    ...
    _i4.BlankNodeTermDeserializer<T>? blankNodeDeserializer,
  }) =>
      (super.noSuchMethod(
            Invocation.method(
              #require,
  ...
  Map<K, V> getMap<K, V>(
    ...
    _i4.BlankNodeTermDeserializer<MapEntry<K, V>>? blankNodeDeserializer,
  }) =>
      (super.noSuchMethod(
            Invocation.method(
              #getMap,
